...
export const POSTERS = [
    ...
    },
    {
        ...
        style: "3d", aspectRatio: "1:1", primaryModel: "dalle3",
        previewImage: "/placeholders/holi-002.jpg",
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/holi-002-mj.jpg", quality: "medium", renderTime: "~40s", notes: "A bit too realistic" },
            { model: "dalle3", imageUrl: "/placeholders/holi-002-dalle.jpg", quality: "high", renderTime: "~15s", notes: "Nailed the Pixar aesthetic" },
            { model: "flux", imageUrl: "/placeholders/holi-002-flux.jpg", quality: "high", renderTime: "~20s", notes: "Excellent lighting" },
            { model: "stable-diffusion", imageUrl: "/placeholders/holi-002-sd.jpg", quality: "low", renderTime: "~50s", notes: "Struggled with 3D style" }
        ],
    ...
    },
    {
        ...
        style: "watercolor", aspectRatio: "16:9", primaryModel: "midjourney",
        previewImage: "/placeholders/holi-003.jpg",
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/holi-003-mj.jpg", quality: "high", renderTime: "~35s", notes: "Beautiful authentic texture" },
            { model: "dalle3", imageUrl: "/placeholders/holi-003-dalle.jpg", quality: "medium", renderTime: "~18s", notes: "A bit too structured for watercolor" },
            { model: "flux", imageUrl: "/placeholders/holi-003-flux.jpg", quality: "high", renderTime: "~22s", notes: "Great ink bleeds" },
            { model: "stable-diffusion", imageUrl: "/placeholders/holi-003-sd.jpg", quality: "medium", renderTime: "~45s", notes: "Decent colors" }
        ],
    ...
    },
    {
        ...
        style: "cinematic", aspectRatio: "9:16", primaryModel: "midjourney",
        previewImage: "/placeholders/holi-004.jpg",
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/holi-004-mj.jpg", quality: "high", renderTime: "~50s", notes: "Incredible glowing dust" },
            { model: "dalle3", imageUrl: "/placeholders/holi-004-dalle.jpg", quality: "medium", renderTime: "~25s", notes: "Good concept, less cinematic" },
            { model: "flux", imageUrl: "/placeholders/holi-004-flux.jpg", quality: "high", renderTime: "~20s", notes: "Perfect scifi lighting" },
            { model: "stable-diffusion", imageUrl: "/placeholders/holi-004-sd.jpg", quality: "low", renderTime: "~55s", notes: "Messy composition" }
        ],
    ...
    // IPL 2025
    {
        ...
        style: "photorealistic", aspectRatio: "16:9", primaryModel: "midjourney",
        previewImage: "/placeholders/ipl-001.jpg",
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/ipl-001-mj.jpg", quality: "high", renderTime: "~40s", notes: "Massive scale captured perfectly" },
            { model: "dalle3", imageUrl: "/placeholders/ipl-001-dalle.jpg", quality: "high", renderTime: "~20s", notes: "Great stadium geometry" },
            { model: "flux", imageUrl: "/placeholders/ipl-001-flux.jpg", quality: "medium", renderTime: "~15s", notes: "A bit dark" },
            { model: "stable-diffusion", imageUrl: "/placeholders/ipl-001-sd.jpg", quality: "low", renderTime: "~60s", notes: "Pitch looks like a football field" }
        ],
    ...
    },
    {
        ...
        style: "illustration", aspectRatio: "4:5", primaryModel: "dalle3",
        previewImage: "/placeholders/ipl-002.jpg",
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/ipl-002-mj.jpg", quality: "medium", renderTime: "~30s", notes: "Too detailed for vector" },
            { model: "dalle3", imageUrl: "/placeholders/ipl-002-dalle.jpg", quality: "high", renderTime: "~15s", notes: "Perfect clean pop-art lines" },
            { model: "flux", imageUrl: "/placeholders/ipl-002-flux.jpg", quality: "medium", renderTime: "~20s", notes: "Good motion" },
            { model: "stable-diffusion", imageUrl: "/placeholders/ipl-002-sd.jpg", quality: "low", renderTime: "~40s", notes: "Anatomy is broken" }
        ],
    ...
    },
    {
        ...
        style: "3d", aspectRatio: "1:1", primaryModel: "flux",
        previewImage: "/placeholders/ipl-003.jpg",
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/ipl-003-mj.jpg", quality: "high", renderTime: "~45s", notes: "Very dramatic lighting" },
            { model: "dalle3", imageUrl: "/placeholders/ipl-003-dalle.jpg", quality: "high", renderTime: "~20s", notes: "Great confetti" },
            { model: "flux", imageUrl: "/placeholders/ipl-003-flux.jpg", quality: "high", renderTime: "~18s", notes: "Perfect gold reflections" },
            { model: "stable-diffusion", imageUrl: "/placeholders/ipl-003-sd.jpg", quality: "medium", renderTime: "~50s", notes: "A bit noisy" }
        ],
    ...
    },
    {
        ...
        style: "illustration", aspectRatio: "9:16", primaryModel: "dalle3",
        previewImage: "/placeholders/ipl-004.jpg",
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/ipl-004-mj.jpg", quality: "high", renderTime: "~35s", notes: "Great distressed look" },
            { model: "dalle3", imageUrl: "/placeholders/ipl-004-dalle.jpg", quality: "high", renderTime: "~18s", notes: "Nails the typography placeholder" },
            { model: "flux", imageUrl: "/placeholders/ipl-004-flux.jpg", quality: "medium", renderTime: "~20s", notes: "A little too modern" },
            { model: "stable-diffusion", imageUrl: "/placeholders/ipl-004-sd.jpg", quality: "low", renderTime: "~45s", notes: "Looks like a bad photo" }
        ],
    ...
    // Eid 2025
    {
        ...
        style: "illustration", aspectRatio: "4:5", primaryModel: "midjourney",
        previewImage: "/placeholders/eid-001.jpg",
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/eid-001-mj.jpg", quality: "high", renderTime: "~38s", notes: "Beautiful silhouette" },
            { model: "dalle3", imageUrl: "/placeholders/eid-001-dalle.jpg", quality: "high", renderTime: "~19s", notes: "Very clean gradient" },
            { model: "flux", imageUrl: "/placeholders/eid-001-flux.jpg", quality: "high", renderTime: "~16s", notes: "Excellent glow effect" },
            { model: "stable-diffusion", imageUrl: "/placeholders/eid-001-sd.jpg", quality: "medium", renderTime: "~50s", notes: "A bit generic" }
        ],
    ...
    },
    {
        ...
        style: "photorealistic", aspectRatio: "16:9", primaryModel: "flux",
        previewImage: "/placeholders/eid-002.jpg",
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/eid-002-mj.jpg", quality: "high", renderTime: "~40s", notes: "Incredible metal details" },
            { model: "dalle3", imageUrl: "/placeholders/eid-002-dalle.jpg", quality: "medium", renderTime: "~20s", notes: "Dates look a bit fake" },
            { model: "flux", imageUrl: "/placeholders/eid-002-flux.jpg", quality: "high", renderTime: "~15s", notes: "Perfect lighting and depth of field" },
            { model: "stable-diffusion", imageUrl: "/placeholders/eid-002-sd.jpg", quality: "medium", renderTime: "~60s", notes: "Good atmosphere" }
        ],
    ...
    },
    {
        ...
        style: "3d", aspectRatio: "16:9", primaryModel: "dalle3",
        previewImage: "/placeholders/eid-003.jpg",
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/eid-003-mj.jpg", quality: "high", renderTime: "~45s", notes: "Incredible metallic reflections" },
            { model: "dalle3", imageUrl: "/placeholders/eid-003-dalle.jpg", quality: "high", renderTime: "~18s", notes: "Perfect geometry" },
            { model: "flux", imageUrl: "/placeholders/eid-003-flux.jpg", quality: "medium", renderTime: "~22s", notes: "Slightly less crisp" },
            { model: "stable-diffusion", imageUrl: "/placeholders/eid-003-sd.jpg", quality: "low", renderTime: "~55s", notes: "Pattern broke down at edges" }
        ],
    ...
    // Mother's Day 2025
    {
        ...
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/mom-001-mj.jpg", quality: "high", renderTime: "~35s", notes: "Beautiful soft shadows" },
            { model: "dalle3", imageUrl: "/placeholders/mom-001-dalle.jpg", quality: "high", renderTime: "~20s", notes: "Perfect blank card placement" },
            { model: "flux", imageUrl: "/placeholders/mom-001-flux.jpg", quality: "high", renderTime: "~16s", notes: "Flowers look incredibly real" },
            { model: "stable-diffusion", imageUrl: "/placeholders/mom-001-sd.jpg", quality: "medium", renderTime: "~50s", notes: "A bit overexposed" }
        ],
    ...
    },
    {
        ...
        style: "illustration", aspectRatio: "16:9", primaryModel: "dalle3",
        previewImage: "/placeholders/mom-002.jpg",
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/mom-002-mj.jpg", quality: "medium", renderTime: "~30s", notes: "A bit too painterly" },
            { model: "dalle3", imageUrl: "/placeholders/mom-002-dalle.jpg", quality: "high", renderTime: "~15s", notes: "Perfect flat vector style" },
            { model: "flux", imageUrl: "/placeholders/mom-002-flux.jpg", quality: "high", renderTime: "~18s", notes: "Lovely warm lighting" },
            { model: "stable-diffusion", imageUrl: "/placeholders/mom-002-sd.jpg", quality: "low", renderTime: "~40s", notes: "Faces are distorted" }
        ],
    ...
    },
    {
        ...
        style: "watercolor", aspectRatio: "1:1", primaryModel: "flux",
        previewImage: "/placeholders/mom-003.jpg",
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/mom-003-mj.jpg", quality: "high", renderTime: "~30s", notes: "Beautiful color blend" },
            { model: "dalle3", imageUrl: "/placeholders/mom-003-dalle.jpg", quality: "medium", renderTime: "~18s", notes: "Added unwanted text" },
            { model: "flux", imageUrl: "/placeholders/mom-003-flux.jpg", quality: "high", renderTime: "~15s", notes: "Perfect clean center" },
            { model: "stable-diffusion", imageUrl: "/placeholders/mom-003-sd.jpg", quality: "medium", renderTime: "~45s", notes: "Good simple rendering" }
        ],
    ...
    // Diwali 2025
    {
        ...
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/diwali-001-mj.jpg", quality: "high", renderTime: "~45s", notes: "Incredible reflections" },
            { model: "dalle3", imageUrl: "/placeholders/diwali-001-dalle.jpg", quality: "high", renderTime: "~20s", notes: "Great temple silhouette" },
            { model: "flux", imageUrl: "/placeholders/diwali-001-flux.jpg", quality: "high", renderTime: "~18s", notes: "Amazing firelight glow" },
            { model: "stable-diffusion", imageUrl: "/placeholders/diwali-001-sd.jpg", quality: "medium", renderTime: "~55s", notes: "A bit noisy in shadows" }
        ],
    ...
    },
    {
        ...
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/diwali-002-mj.jpg", quality: "high", renderTime: "~40s", notes: "Perfect marble reflections" },
            { model: "dalle3", imageUrl: "/placeholders/diwali-002-dalle.jpg", quality: "high", renderTime: "~18s", notes: "Extremely clean geometry" },
            { model: "flux", imageUrl: "/placeholders/diwali-002-flux.jpg", quality: "high", renderTime: "~15s", notes: "Best flower textures" },
            { model: "stable-diffusion", imageUrl: "/placeholders/diwali-002-sd.jpg", quality: "low", renderTime: "~60s", notes: "Lost the 3D depth" }
        ],
    ...
    },
    {
        ...
        style: "anime", aspectRatio: "9:16", primaryModel: "midjourney",
        previewImage: "/placeholders/diwali-003.jpg",
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/diwali-003-mj.jpg", quality: "high", renderTime: "~35s", notes: "Nailed the Shinkai sky" },
            { model: "dalle3", imageUrl: "/placeholders/diwali-003-dalle.jpg", quality: "medium", renderTime: "~15s", notes: "Text 'Happy Diwali' rendered poorly" },
            { model: "flux", imageUrl: "/placeholders/diwali-003-flux.jpg", quality: "medium", renderTime: "~20s", notes: "Good lighting, face is a bit off" },
            { model: "stable-diffusion", imageUrl: "/placeholders/diwali-003-sd.jpg", quality: "high", renderTime: "~40s", notes: "Great anime aesthetic (Niji type)" }
        ],
    ...
    },
    {
        ...
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/diwali-004-mj.jpg", quality: "medium", renderTime: "~30s", notes: "A bit too textured" },
            { model: "dalle3", imageUrl: "/placeholders/diwali-004-dalle.jpg", quality: "high", renderTime: "~15s", notes: "Perfect flat luxury aesthetic" },
            { model: "flux", imageUrl: "/placeholders/diwali-004-flux.jpg", quality: "medium", renderTime: "~20s", notes: "Good contrast" },
            { model: "stable-diffusion", imageUrl: "/placeholders/diwali-004-sd.jpg", quality: "low", renderTime: "~40s", notes: "Missed the minimal prompt entirely" }
        ],
    ...
    // New Year 2026
    {
        ...
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/ny-001-mj.jpg", quality: "high", renderTime: "~45s", notes: "Incredible sense of scale" },
            { model: "dalle3", imageUrl: "/placeholders/ny-001-dalle.jpg", quality: "high", renderTime: "~22s", notes: "Got the text elements right" },
            { model: "flux", imageUrl: "/placeholders/ny-001-flux.jpg", quality: "high", renderTime: "~20s", notes: "Perfect neon reflections" },
            { model: "stable-diffusion", imageUrl: "/placeholders/ny-001-sd.jpg", quality: "medium", renderTime: "~55s", notes: "A bit cluttered" }
        ],
    ...
    },
    {
        ...
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/ny-002-mj.jpg", quality: "high", renderTime: "~40s", notes: "Gorgeous bokeh" },
            { model: "dalle3", imageUrl: "/placeholders/ny-002-dalle.jpg", quality: "medium", renderTime: "~18s", notes: "Glasses look a little distorted" },
            { model: "flux", imageUrl: "/placeholders/ny-002-flux.jpg", quality: "high", renderTime: "~16s", notes: "Perfect glass reflections and liquid" },
            { model: "stable-diffusion", imageUrl: "/placeholders/ny-002-sd.jpg", quality: "low", renderTime: "~45s", notes: "Weird artifacts in the liquid" }
        ],
    ...
    },
    {
        ...
        modelOutputs: [
            { model: "midjourney", imageUrl: "/placeholders/ny-003-mj.jpg", quality: "medium", renderTime: "~35s", notes: "Struggled with the numbers 2025/2026" },
            { model: "dalle3", imageUrl: "/placeholders/ny-003-dalle.jpg", quality: "high", renderTime: "~15s", notes: "Perfect typography generation" },
            { model: "flux", imageUrl: "/placeholders/ny-003-flux.jpg", quality: "high", renderTime: "~18s", notes: "Great materials" },
            { model: "stable-diffusion", imageUrl: "/placeholders/ny-003-sd.jpg", quality: "low", renderTime: "~50s", notes: "Gibberish text on calendar" }
        ],
